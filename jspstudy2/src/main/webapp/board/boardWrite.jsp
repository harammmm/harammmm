...
<body>
	...
	<table border=1 style="width: 800px;">
		<form name="frm">
			...
			<tr>
				<td>내용</td>
				<td><textarea placeholder="내용을 입력해주세요." name="content"
						cols="100" rows="10">
</textarea></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="writer" size="50"
					value=<%=session.getAttribute("memberName")%> readonly="readonly"></td>
			</tr>
			<tr>
				<td>파일 업로드</td>
			...
			<tr>
				<td colspan=2 style="text-align: center;"><input type="button"
					name="btn" value="확인" onclick="check();"> <input
