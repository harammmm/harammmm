...
<form name="frm" action="<%=request.getContextPath() %>/board/boardList.do" method="post"> <center>

<table border=0 style="width:299px; text-align:right; margin:45px">
<tr>
...
<td style="width:185px;">
	<input type="submit" class="btn btn-light"  name="submit" value="검색">	
</td>
<td>
<input type="button" class="btn btn-light"  name="button" value="글쓰기" onClick="location.href='<%=request.getContextPath()%>/board/boardWrite.do'">
</td>
</tr>
</table>
</form>
